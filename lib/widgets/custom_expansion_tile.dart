...
class CustomExpansionTileState extends State<CustomExpansionTile> with SingleTickerProviderStateMixin {
  ...
  void initState() {
    ...
    _iconTurns = _controller.drive((widget.animatedWidgetTurnTween ?? CustomExpansionTile._halfTween)
        .chain(widget.animatedWidgetTween ?? CustomExpansionTile._easeInTween));

    _borderColor = _controller.drive(_borderColorTween.chain(widget.borderAnimationTween ?? CustomExpansionTile._easeOutTween));
    _borderColorTween.end = widget.borderColorEnd;

    _headerColor = _controller.drive(_headerColorTween.chain(widget.headerAnimationTween ?? CustomExpansionTile._easeInTween));
